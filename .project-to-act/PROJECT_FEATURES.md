...
| F-008 | M6 财务：成本核算链 + 成本明细账 | M6-开发计划-v2口径-20260913.md §0 | P0 | 进行中 | 增量验收（E-008） | F-004 | 成本链可按 D5/D6 口径算出并落快照；三段式（先批准后落库）生效；试算/正式分离；28 件工具注册（已 24/28：B0b 4 + B1 9 + B2 6 + B3 2 + B4 3） | M6-开发计划 §3–§7 | E-008 |
